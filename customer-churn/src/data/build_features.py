"""
Feature engineering utilities for the churn prediction project.

This module provides functions to transform raw customer data into
machine learning-ready features using binary encoding and one-hot encoding.
"""
