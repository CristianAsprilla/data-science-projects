"""
Model inference and serving utilities for the churn prediction project.

This module provides the complete inference pipeline for making predictions
on new customer data using the trained XGBoost model. It ensures feature
transformations are identical to training to prevent train/serve skew.
"""
